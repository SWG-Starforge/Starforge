...
object_tangible_deed_vehicle_deed_barc_speeder_imperial_crafted_deed = object_tangible_deed_vehicle_deed_shared_barc_speeder_imperial_crafted_deed:new {
	...
	experimentalMin = {0, 0, 750, 0, 18.5, 75, 12.5},
	experimentalMax = {0, 0, 2000, 0, 35, 80, 15},
	experimentalPrecision = {0, 0, 0, 0, 2, 1, 2},
	experimentalCombineType = {0, 0, 1, 0, 1, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_deed_vehicle_deed_barc_speeder_imperial_crafted_deed, "object/tangible/deed/vehicle_deed/barc_speeder_imperial_crafted_deed.iff")
