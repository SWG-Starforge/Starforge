...
object_draft_schematic_weapon_shared_fishingpole = SharedDraftSchematicObjectTemplate:new {
	clientTemplateFileName = "object/draft_schematic/weapon/shared_fishingpole.iff"}
ObjectTemplates:addClientTemplate(object_draft_schematic_weapon_shared_fishingpole, 
"object/draft_schematic/weapon/shared_fishingpole.iff")