...
object_weapon_melee_2h_sword_2h_sword_fishingpole = object_weapon_melee_2h_sword_shared_2h_sword_fishingpole:new {
	...
	--certificationsRequired = { "cert_sword_2h_fishingpole" },
...
ObjectTemplates:addTemplate(object_weapon_melee_2h_sword_2h_sword_fishingpole, "object/weapon/melee/2h_sword/2h_sword_fishingpole.iff")
