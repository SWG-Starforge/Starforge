...
--custom
object_weapon_melee_2h_sword_shared_2h_sword_fishingpole = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/melee/2h_sword/shared_2h_sword_fishingpole.iff"}
ObjectTemplates:addClientTemplate(object_weapon_melee_2h_sword_shared_2h_sword_fishingpole, 
"object/weapon/melee/2h_sword/shared_2h_sword_fishingpole.iff")